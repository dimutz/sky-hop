...
class GameMenu:
	...
	def main_menu(self, game_loop=None):
		while True:
			...
			start_action = self.draw_button("New Game", self.width // 2 - 100, 200, 200, 50, LIGHT_PINK, PINK, lambda: "start")
			how_to_play_action = self.draw_button("How to play", self.width // 2 - 100, 300, 200, 50, LIGHT_PINK, PINK, lambda: "how to play")
			quit_action = self.draw_button("Quit", self.width // 2 - 100, 400, 200, 50, LIGHT_PINK, PINK, lambda: "quit")
